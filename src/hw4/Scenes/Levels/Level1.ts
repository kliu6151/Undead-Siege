...
export default class Level1 extends MainHW4Scene {
  ...
  public static readonly PLAYER_SPRITE_PATH =
    "assets/spritesheets/Soldier.json";
  ...
  public static readonly HEALTHPACK_SPAWNS_PATH =
    "assets/data/items/healthpacks.json";

  public static readonly LASERGUN_SPAWNS = "LASERGUN_SPAWNS";
  public static readonly LASERGUN_SPAWNS_PATH =
    "assets/data/items/laserguns.json";

  // Load the material and fuel locations
  public static readonly MATERIAL_SPAWNS = "MATERIAL_SPAWNS";
  public static readonly MATERIAL_SPAWNS_PATH =
    "assets/data/items/materials.json";
  ...
  public static readonly ZOMBIE_GROWL_AUDIO_PATH =
    "assets/sounds/zombie_growl.wav";

  public static readonly PLAYER_DAMAGED_AUDIO_KEY = "PLAYER_DAMAGED";
  public static readonly PLAYER_DAMAGED_AUDIO_PATH =
    "assets/sounds/player_hit.mp3";

  public static readonly HELICOPTER_DAMAGED_AUDIO_KEY = "HELICOPTER_DAMAGED";
  public static readonly HELICOPTER_DAMAGED_AUDIO_PATH =
  ...
  public override loadScene() {
    ...
    this.load.spritesheet("helicopter", Level1.HELI_SPRITE_PATH);
    ...
    this.load.audio(
      this.playerDamagedAudioKey,
      Level1.PLAYER_DAMAGED_AUDIO_PATH
    );
    this.load.audio(
      this.helicopterDamagedAudioKey,
      Level1.HELICOPTER_DAMAGED_AUDIO_PATH
    );
